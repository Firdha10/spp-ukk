                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-3 mt-3 ml-lg-3 mr-lg-3">
                                        <div class="col-lg-12">
                                            <h4 class="mb-5 mt-3 text-center"><strong>Detail Siswa</strong></h4>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-lg-4 col-5">Kelas</div>
                                                <div class="col-1 text-right">:</div>
                                                <div class="col-lg-6 col-5">{{$data->kelas->kelas}}</div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-lg-4 col-5">Jurusan</div>
                                                <div class="col-1 text-right">:</div>
                                                <div class="col-lg-6 col-5">{{$data->jurusan->jurusan}}</div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col-lg-4 col-5">Spp</div>
                                                <div class="col-1 text-right">:</div>
                                                <div class="col-lg-6 col-5">Tahun {{$data->spp->tahun}} - {{$data->spp->nominal}}</div>
                                            </div>
                                            <div class="row mb-4">
